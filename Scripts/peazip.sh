...
cp "/userdata/system/.dev/apps/peazip/extra/peazip.desktop" /usr/share/applications/ 2>/dev/null || { log_error "Erro ao copiar o aplicativo para o diretório de execução."; exit 1; }
