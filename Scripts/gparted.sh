...
url="https://github.com/JeversonDiasSilva/releses/releases/download/v1.0.0/GPARTED"
...
cp "/userdata/system/.dev/apps/gparted/extra/gparted.desktop" /usr/share/applications/ 2>/dev/null || { log_error "Erro ao copiar o aplicativo para o diretório de execução."; exit 1; }
